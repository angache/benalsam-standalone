// functions/listing-status-change/index.ts
...
// IMPORTANT: Function Supabase Dashboard'da "Verify JWT" KAPALI olmalı
// Çünkü PostgreSQL trigger'lardan authorization header olmadan çağrılıyor
...
serve(async (req) => {
  ...
  try {
    ...
    const requestBody = {
      ...
      // Source & Context
      source: "supabase",
      serviceName: "listing-status-change-edge-function",
      version: "1.0.0",
