...
COMMENT ON FUNCTION "public"."sync_ai_suggestion_to_elasticsearch"() IS 'AI suggestions için Elasticsearch sync fonksiyonu. Kategori bilgilerini de dahil eder.';
...
COMMENT ON TRIGGER "category_ai_suggestions_elasticsearch_sync" ON "public"."category_ai_suggestions" IS 'AI suggestions tablosu için Elasticsearch sync trigger. INSERT/UPDATE/DELETE işlemlerini yakalar.';
