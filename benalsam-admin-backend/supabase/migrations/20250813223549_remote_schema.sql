...
CREATE OR REPLACE FUNCTION "public"."add_to_elasticsearch_queue"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    record_id UUID;
...
ALTER FUNCTION "public"."add_to_elasticsearch_queue"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_elasticsearch_queue_stats"() RETURNS TABLE("total_jobs" integer, "pending_jobs" integer, "processing_jobs" integer, "completed_jobs" integer, "failed_jobs" integer, "avg_processing_time" interval)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY
...
CREATE INDEX "idx_elasticsearch_sync_queue_table_record" ON "public"."elasticsearch_sync_queue" USING "btree" ("table_name", "record_id");
...
CREATE OR REPLACE TRIGGER "listings_queue_sync" AFTER INSERT OR DELETE OR UPDATE ON "public"."listings" FOR EACH ROW EXECUTE FUNCTION "public"."add_to_elasticsearch_queue"();
...
GRANT ALL ON FUNCTION "public"."add_to_elasticsearch_queue"() TO "anon";
GRANT ALL ON FUNCTION "public"."add_to_elasticsearch_queue"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_to_elasticsearch_queue"() TO "service_role";
