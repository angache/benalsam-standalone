...
/**
 * Cache Service Proxy Routes
 * 
 * Bu routes admin backend'den Cache Service'e proxy yapar
 */
...
// Cache get endpoint
router.post('/get', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
// Cache set endpoint
router.post('/set', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.post('/clear', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.get('/memory/stats', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.get('/redis/stats', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export { router as cacheProxyRoutes };
