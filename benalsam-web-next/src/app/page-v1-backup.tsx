/**
 * Homepage V1 - BACKUP VERSION
 * 
 * This is the original homepage with filters and infinite scroll.
 * Kept as backup in case we need to revert.
 * 
 * To restore: rename this to page.tsx
 */
...
export default function HomePageV1Backup() {
