          ...
          >
            <div className="p-4 sm:p-6">
              ...
              <nav className="space-y-1 sm:space-y-2">
                ...
                {currentUser && (
                  <>
                    <Link href={`/profil/${currentUser.id}`} onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                        <UserCircle className="w-4 h-4 mr-3" /> Profilim
                      </Button>
                    </Link>
                     <Link href="/mesajlarim" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                    ...
                    <Link href="/ilanlarim" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                        <FileText className="w-4 h-4 mr-3" /> İlanlarım
                      </Button>
                    </Link>
                    <Link href="/envanterim" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                        <Package className="w-4 h-4 mr-3" /> Envanterim
                      </Button>
                    </Link>
                    <Link href="/favorilerim" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                        <Heart className="w-4 h-4 mr-3" /> Favorilerim
                      </Button>
                    </Link>
                    <Link href="/takip-edilenler" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                        <Users className="w-4 h-4 mr-3" /> Takip Ettiklerim
                      </Button>
                    </Link>
                    <Link href="/aldigim-teklifler" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                        <MessageSquare className="w-4 h-4 mr-3" /> Aldığım Teklifler
                      </Button>
                    </Link>
                    <Link href="/gonderdigim-teklifler" onClick={() => setIsOpen(false)}>
                      <Button variant="ghost" className="w-full justify-start text-sm">
                    ...
                    {!isPremiumUser && (
                      <Link href="/ayarlar/premium" onClick={() => setIsOpen(false)}>
