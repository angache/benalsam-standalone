          ...
          },
          {
            ...
            value: process.env.NODE_ENV === 'production'
              ? [
                  ...
                  "script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://apis.google.com https://cdn.jsdelivr.net",
                  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
                  "img-src 'self' data: blob: https: http:",
                  "font-src 'self' data: https://fonts.gstatic.com",
                  "connect-src 'self' https://api.benalsam.com https://*.supabase.co wss://*.supabase.co https://images.unsplash.com https://api.unsplash.com https://nominatim.openstreetmap.org data: blob:",
              ...
              : [
                  ...
                  "img-src 'self' data: blob: https: http:",
                  "font-src 'self' data: https://fonts.gstatic.com",
                  "connect-src 'self' https://api.benalsam.com https://*.supabase.co wss://*.supabase.co https://images.unsplash.com https://api.unsplash.com https://nominatim.openstreetmap.org data: blob: http://localhost:* ws://localhost:* wss://localhost:* ws://0.0.0.0:* http://127.0.0.1:7242",
                  "frame-src 'self' https://accounts.google.com",
                  "object-src 'none'",
                  "base-uri 'self'",
                  "form-action 'self'",
