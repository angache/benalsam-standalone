...
const DesignSystemDemoPage = lazy(() => import('@/pages/DesignSystemDemoPage'));
  ...
  return (
    <MainContent>
      <Routes location={location}>
        ...
        <Route path="/design-system" element={withPageErrorBoundary(DesignSystemDemoPage, 'Design System Demo')} />
