...
export class ValidationMiddleware {
    ...
    static validateFileUpload(options = {}) {
        ...
        allowedTypes = ['image/jpeg', 'image/png', 'image/gif', 'image/webp'], required = true, maxFiles = 10 } = options;
        return (req, res, next) => {
     ...
     */
    static validateSingleFile(file, maxSize, allowedTypes) {
        const errors = [];
        // Check file size
...
export const COMMON_SCHEMAS = {
    ...
    jobCreate: Joi.object({
        type: Joi.string().valid('IMAGE_UPLOAD_REQUESTED', 'IMAGE_UPLOAD_PROCESSING', 'IMAGE_UPLOAD_COMPLETED', 'IMAGE_UPLOAD_FAILED', 'IMAGE_RESIZE', 'THUMBNAIL_GENERATE', 'METADATA_EXTRACT', 'VIRUS_SCAN', 'DATABASE_UPDATE', 'NOTIFICATION_SEND', 'CLEANUP_TEMP_FILES').required(),
