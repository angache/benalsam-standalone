...
# ==============================================================================
# VPS CORS Code Update Script (Local'den çalıştırılacak)
# ==============================================================================
# Bu script local'den VPS'deki servislerin kodlarını günceller
# Local'de çalıştırın: ./scripts/vps-update-cors-code-local.sh
# ==============================================================================
...
echo -e "${BLUE}🚀 VPS CORS Code Update Script (Local → VPS)${NC}"
echo "=========================================="
echo ""
...
update_service() {
    ...
    if [ $? -eq 0 ]; then
        ...
        ssh -o StrictHostKeyChecking=no "$VPS_USER@$VPS_IP" "cd $VPS_SERVICE_DIR && npm install && npm run build"
